...
int main() {
    int res = 0;
    //res += sortion_test(classic_insertion_sort, not_req, 0, 150000, 5000, 5, "test_classic_insertion_sort.txt"); //зеленый
    //res += sortion_test(watchdog_element_insertion_sort, not_req, 0, 150000, 5000, 5, "test_watchdog_element_insertion_sort.txt"); //розовый
    //res += sortion_test(binary_search_insertion_sort, not_req, 0, 150000, 5000, 5, "test_binary_search_insertion_sort.txt"); //синий
    //res += sortion_test(classic_shell_sort, not_req, 0, 1500000, 5000, 5, "test_classic_shell_sort.txt"); //коричневый
    //res += sortion_test(shell_sort, step_shell, 0, 1500000, 5000, 5, "test_step_shell.txt"); //красный
    //res += sortion_test(shell_sort, step_frank_and_lazarus, 0, 1500000, 5000, 5, "test_step_frank_and_lazarus.txt"); //болотный
    //res += sortion_test(shell_sort, step_hibbard, 0, 1500000, 5000, 5, "test_step_hibbard.txt");//фиолетовый
    //res += sortion_test(shell_sort, step_papernov_and_stasivich, 0, 1500000, 5000, 5, "test_step_papernov_and_stasivich.txt");//желтый
    //res += sortion_test(shell_sort, step_pratt, 0, 1500000, 5000, 5, "test_step_pratt1.txt");//серый
    //res += sortion_test(shell_sort, step_knuth, 0, 1500000, 5000, 5, "test_step_knuth.txt");//голубой
    //res += sortion_test(shell_sort, step_sedgewick_1, 0, 1500000, 5000, 5, "test_step_sedgewick_1.txt");//светло-серый
    //res += sortion_test(shell_sort, step_sedgewick_2, 0, 1500000, 5000, 5, "test_step_sedgewick_2.txt");//салатовый
    //res += sortion_test(shell_sort, step_gonnet_and_baeza_yates, 0, 1500000, 5000, 5, "test_step_gonnet_and_baeza_yates.txt");//темно-синий
    //res += sortion_test(shell_sort, step_tokuda, 0, 1500000, 5000, 5, "test_step_tokuda.txt");//бирюзовый
    //res += sortion_test(shell_sort, step_ciura, 0, 1500000, 5000, 5, "test_step_ciura.txt");//черный
    return res;
}
